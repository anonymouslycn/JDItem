...
def parse_item_pages(browser, urls, limit=-1):
    ...
    for i, url in enumerate(urls):
        ...
        try:
            ...
            browser.find_elements_by_class_name(' tag-1')
...
if __name__ == "__main__":
    ...
    CLASS_URL = "https://search.jd.com/Search?keyword=%E5%8C%BB%E7%94%A8%E5%8F%A3%E7%BD%A9&enc=utf-8&spm=2.1.2"   # 需制定类别URL
